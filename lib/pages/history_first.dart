...
class history_first extends StatefulWidget {
  ...
  const history_first({Key? key}) : super(key: key);

  @override
  _history_firstState createState() => _history_firstState();
}

class _history_firstState extends State<history_first> {
